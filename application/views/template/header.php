            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color: #e3f2fd;">
                ...
                <div class="collapse navbar-collapse  justify-content-between" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        <a class="nav-item nav-link " href="">Content <span class="sr-only">(current)</span></a>
                        <a class="nav-item nav-link" href="#">Features</a>
                        <a class="nav-item nav-link" href="#">Pricing</a>
                        <a class="nav-item nav-link disabled" href="#">Disabled</a>
                    </div>
                    <span class="navbar-text text-right">
                    <a href="<?php base_url(); ?>/user/login" class="btn btn-outline-success" type="button">Login</a>
                    <a href="<?php base_url()?>/signup" class="btn btn-outline-success" type="button">Signup</a>
    </span>
                </div>
            </nav>
        </div>
